...
class RadioGroup extends YMRView<RadioGroupController> {
  ...
  @override
  RadioGroupController initController() => RadioGroupController();

  @override
  RadioGroupController attachController(RadioGroupController controller) {
    return controller.fromRadioGroupView(this);
  }

  @override
  Widget? attach(BuildContext context, RadioGroupController controller) {
...
class RadioGroupController extends ViewController {
  RadioGroupController fromRadioGroupView(RadioGroup view) {
    super.fromView(view);
        ...
        Radio(
          ...
          fillColor: MaterialStateProperty.resolveWith((Set states) {
            if (states.contains(MaterialState.selected)) {
              ...
              return radioUnselectedColor ?? context.primaryColor;
            }
          }),
        ),
        TextView(
